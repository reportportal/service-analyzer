    ...
    node("${label}") {
        ...
        stage('Deploy to Dev') {
            container('helm') {
                ...
                sh "helm upgrade -n reportportal --set serviceanalyzer.repository=$srvRepo --set serviceanalyzer.tag=$srvVersion --wait -f $ciDir/rp/values-ci.yml reportportal ./$k8sChartDir"
            }
        }
